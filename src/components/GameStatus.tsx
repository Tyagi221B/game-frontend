    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4 animate-fade-in">
      <div className="relative bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-10 w-full max-w-md mx-4 border-4 border-white/50">
        ...
        <div className="text-center mb-6">
          {isDraw ? (
            <div className="w-24 h-24 mx-auto bg-linear-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center shadow-lg border-4 border-white">
              <svg className="w-12 h-12 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
            </div>
          ) : isWinner ? (
            <div className="w-24 h-24 mx-auto bg-linear-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg border-4 border-yellow-300 animate-bounce-slow">
              <svg className="w-12 h-12 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" />
              </svg>
            </div>
          ) : (
            <div className="w-24 h-24 mx-auto bg-linear-to-br from-red-100 to-red-200 rounded-full flex items-center justify-center shadow-lg border-4 border-red-300">
        ...
        <div className="text-center mb-8">
          {isDraw ? (
            <>
              <h2 className="text-4xl font-black text-transparent bg-clip-text bg-linear-to-r from-gray-600 to-gray-800 mb-3">
                It's a Draw!
              </h2>
            ...
            <>
              <h2 className="text-4xl font-black text-transparent bg-clip-text bg-linear-to-r from-yellow-500 to-orange-600 mb-3">
                Victory! 🎉
              </h2>
            ...
            <>
              <h2 className="text-4xl font-black text-transparent bg-clip-text bg-linear-to-r from-red-500 to-red-700 mb-3">
                Defeat
              </h2>
        ...
        {/* Game Stats */}
        <div className="bg-linear-to-br from-indigo-50 to-purple-50 rounded-2xl p-6 mb-6 border-2 border-indigo-100">
